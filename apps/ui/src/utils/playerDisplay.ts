...
const FIELD_LABEL_OVERRIDES: Record<string, string> = {
  ...
  'PRECISIÓN   P CORTO': 'Precisión Pase Corto',
  'VELOCIDAD  P CORTO': 'Velocidad Pase Corto',
  'PRECISIÓN       P LARGO': 'Precisión Pase Largo',
  'VELOCIDAD     P LARGO': 'Velocidad Pase Largo',
